...
Converting an app to a package requires a little work. Follow these steps to create an package. I'm assuming that your app is called `myApp` and it already lives in a directory called `myApp/`.
